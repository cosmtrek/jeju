...
func TestSearchDefaultSkipsGeneratedRunDirs(t *testing.T) {
	...
	writeSearchFile(t, box, "examples/bug-rescue-agent/.jeju-dev/config.yaml", "needle\n")
	writeSearchFile(t, box, "runs/20260531/artifact.txt", "needle\n")
	writeSearchFile(t, box, "examples/bug-rescue-agent/runs/20260531/artifact.txt", "needle\n")
	writeSearchFile(t, box, "examples/bug-rescue-agent/subdir/runs/source.txt", "needle\n")
	...
	for _, path := range []string{
		...
		"src/dist/source.go",
		"pkg/build/source.go",
		"examples/bug-rescue-agent/.jeju-dev/config.yaml",
		"examples/bug-rescue-agent/subdir/runs/source.txt",
	} {
