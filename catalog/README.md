...
|---|---|---|---|---|
| `coding/code-review` | Review local Git working tree changes and return structured findings. | `deepseek-v4-pro` | read-only | `jeju package add jeju:coding/code-review@0.1.0` |
